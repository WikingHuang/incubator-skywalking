...
public final class ReflectUtils {
    ...
    private void sortConstructors(List<Constructor<?>> list) {
        Collections.sort(list, new Comparator<Constructor<?>>() {
            ...
            public int compare(Constructor<?> o1, Constructor<?> o2) {
                return compareClassArray(o1.getParameterTypes(), o2.getParameterTypes());
            }
        });
    }
    ...
    public ReflectUtils field(final String name) {
        try {
            ...
            try {
                return new ReflectUtils(getSimilarField(name).getType(), getSimilarField(name).get(this.object));
    ...
    private Field getSimilarField(String name) throws NoSuchFieldException {
        ...
        throw new NoSuchFieldException("No similar field " + name + " could be found on type " + type() + ".");
    }
    ...
    private int compareClassArray(Class<?>[] parameterTypes, Class<?>[] parameterTypes2) {
        Class<?>[] types1 = parameterTypes;
        Class<?>[] types2 = parameterTypes2;
